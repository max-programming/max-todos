...
import { Card, CardContent, Typography, Container, IconButton, useMediaQuery } from '@material-ui/core';
import CheckTwoToneIcon from '@material-ui/icons/CheckTwoTone';
import DeleteTwoToneIcon from '@material-ui/icons/DeleteTwoTone';
import EditTwoToneIcon from '@material-ui/icons/EditTwoTone';
import DeleteConfirm from './DeleteConfirm';
import EditConfirm from './EditConfirm';
>>>>>>> abca0acb0f60b7b268e2f08fbd35c46f6d473fe6
      ...
      <Card className="root" variant="outlined" style={cardStyles}>
        <CardContent>
          <Typography variant="h5" component="h2" style={checkedStyle} className="todo-text">
            <IconButton style={{ marginRight: 5 }} onClick={() => markComplete(todo.id)} centerRipple={false}>
              <CheckTwoToneIcon color="action" />
            </IconButton>
            {todo.title}
            <IconButton style={{ float: 'right' }} onClick={() => setDeleteOpen(true)} centerRipple={false}>
