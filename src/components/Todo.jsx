...
const Todo = forwardRef(
  ({ todo, markComplete, delTodo, editTodo, index, onDelete, onEdit, markStar }, ref) => {
                ...
                <Typography variant="h5" component="h2" style={checkedStyle} className="todo-text">
                  <Grid container alignItems="center" justify="space-evenly">
                    ...
                    <Grid item xs={4} sm={4} md={2} lg={2}>
                      <IconButton style={styles.icon} onClick={deleteTodo} centerRipple={false}>
                        <DeleteTwoToneIcon color="error" />
                      </IconButton>
                      <IconButton style={styles.icon} onClick={() => setEditOpen(true)} centerRipple={false}>
                        <EditTwoToneIcon color="primary" />
                      </IconButton>
                      <IconButton style={styles.icon} onClick={() => markStar(todo.id)} centerRipple={false}>
                        {todo.stared ? (
                          <StarIcon style={{ color: '#ffd900' }} />
                        ) : (
